...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = findViewById(R.id.edNameReg);
        phone = findViewById(R.id.edPhoneReg);
    ...
    private void registerUser(final String username, final String name, final String phone, String password) {
        ...
        mAuth.createUserWithEmailAndPassword(phone , password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            @Override
