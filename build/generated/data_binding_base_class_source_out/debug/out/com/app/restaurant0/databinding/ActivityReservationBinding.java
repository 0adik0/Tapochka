...
public final class ActivityReservationBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView nameReser;
  ...
  private ActivityReservationBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView imageView2, @NonNull TextView nameReser, @NonNull TextView textView10,
      @NonNull TextView textView11, @NonNull TextView textView12, @NonNull TextView textView9) {
    this.rootView = rootView;
    this.imageView2 = imageView2;
    this.nameReser = nameReser;
  ...
  public static ActivityReservationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.nameReser;
      TextView nameReser = rootView.findViewById(id);
      if (nameReser == null) {
        break missingId;
      }
      ...
      return new ActivityReservationBinding((ConstraintLayout) rootView, imageView2, nameReser,
          textView10, textView11, textView12, textView9);
    }
