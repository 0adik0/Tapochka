...
public final class ItemFeedbackBinding implements ViewBinding {
  ...
  private ItemFeedbackBinding(@NonNull ConstraintLayout rootView, @NonNull TextView feedback,
  ...
  public static ItemFeedbackBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.feedback;
      TextView feedback = rootView.findViewById(id);
      if (feedback == null) {
        break missingId;
      }
      ...
      return new ItemFeedbackBinding((ConstraintLayout) rootView, feedback, name);
    }
